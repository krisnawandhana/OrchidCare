...
const DataSuhuPage = () => {
  ...
  const table1Columns = React.useMemo(() => {
    ...
    return [
      table1ColumnHelper.accessor("rowcell", {
        cell: (info) => (
      ...
      table1ColumnHelper.accessor("labelOne", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("labelTwo", {
        cell: (info) => (
          <Text
            className="flex-1 pb-[27px] pl-[7px] pt-[30px] text-base text-gray-900_01 tracking-[0.30px]"
            size="txtGeneralSansSemibold16"
          >
            {info?.getValue()}
          </Text>
      ...
      table1ColumnHelper.accessor("labelThree", {
        cell: (info) => (
