...
const KelembabanTanahPage = () => {
  ...
  const table2Columns = React.useMemo(() => {
    ...
    return [
      table2ColumnHelper.accessor("rowcell", {
        cell: (info) => (
      ...
      table2ColumnHelper.accessor("labelOne", {
        cell: (info) => (
          <Text
      ...
      table2ColumnHelper.accessor("labelTwo", {
        cell: (info) => (
          <Text
      ...
      table2ColumnHelper.accessor("labelThree", {
        cell: (info) => (
          ...
          >
            ...
            <SubMenu
              icon={
                <Img
                  className="h-6 w-6"
                  src="images/img_profile_white_a700_01.svg"
                  alt="profile"
                />
              }
              label={<Text>Kelembaban Tan... </Text>}
            >
...
export default KelembabanTanahPage;
